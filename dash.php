<?php
session_start();
require_once __DIR__ . '/config.php'; // s'assure du bon chemin vers la config
...
try {
    // Rechercher produits en faible stock
...
try {
    ...
    // SUM peut retourner NULL si aucune vente : COALESCE gère ça côté SQL
...
// Helper pour afficher nom utilisateur en toute sécurité
...
<title>Dashboard - Cold Management</title>
...
<script>
    ...
    // Exemple : console.log(ventesParMois, categories);
</script>
</body>
</html>